...
## Set up some directories - change as needed
IG_RF_dir<-"RF_dists/IG" # object of the directory for the output of the RF comparisons of IG vs. G analyses
NstMixed_rf_dir<-"RF_dists/NstMixed_rf "# object of the directory for the output of the RF comparisons of old vs. analyses with Nst=mixed (model averaged subsitution models)
NewHeat_rf_dir<-"RF_dists/NewHeat_rf" # object of the directory for the output of the RF comparisons of old vs. analyses with new heating
output_dir<-"Reanalyses_Large_set/output" # object to write output plots to 
...
setwd(IG_RF_dir) # set the working directory 
...
par(mfrow=c(3,3))
# For chains that had bad Geweke's
hist(IGvsG_RF_only[,1], col="gray", main=paste("IG vs G 95% con \nMedian = ",med_RF_95,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks = 20)
hist(IGvsG_RF_only[,2], col="gray", main=paste("IG vs G 50% con \nMedian = ",med_RF_50,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks = 5)
hist(IGvsG_RF_only[,3], col="gray", main=paste("IG vs G MCC \nMedian = ",med_RF_MCC,sep=""), xlab="Norm RF", xlim=c(0,1), breaks = 20, ylab=NULL)

hist(NstMixed_RF_only[,1], col="gray", main=paste("Nst Mixed 95% con \nMedian = ",med_RF_95_NstMixed,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks=20)
hist(NstMixed_RF_only[,2], col="gray", main=paste("Nst Mixed 50% con \nMedian = ",med_RF_50_NstMixed,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks=20)
hist(NstMixed_RF_only[,3], col="gray", main=paste("Nst Mixed MCC \nMedian = ",med_RF_MCC_NstMixed,sep=""), xlab="Norm RF", xlim=c(0,1), breaks = 20, ylab=NULL)

hist(New_heat_RF_only[,1], col="gray", main=paste("New Heat 95% con \nMedian = ",med_RF_95_New_heat,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks=20)
hist(New_heat_RF_only[,2], col="gray", main=paste("New Heat 50% con \nMedian = ",med_RF_50_New_heat,sep=""), xlab="Norm RF", xlim=c(0,1), ylab=NULL, breaks=10)
hist(New_heat_RF_only[,3], col="gray", main=paste("New Heat MCC \nMedian = ",med_RF_MCC_New_heat,sep=""), xlab="Norm RF", xlim=c(0,1), breaks = 20, ylab=NULL)
dev.off()# turn off the pdf plotting device
